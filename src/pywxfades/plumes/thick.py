...
def plot(sdo, config):
    """
    Plots a plume of 1000-500 mb thickeness.
    """
    ...
    output_file_path = (Config.OUTPUT_PATH + '/' +
                        ...
                        '1000-500mb Thickness' + '/' + str(sdo.station_name) +
                        '.png')
    # Grab relevant data.
    H50_ht = sdo.data[config.indexes[describe.PLUMES[5][0]]]
    ...
    # Define an axis for the plot.
    plt.axes([0.2000, 0.1500, 0.7500, 0.7500])
    ...
    plt.xticks(numpy.arange(0, H50_ht.shape[2]),labels,size=10)
    # Draw the true plot.
